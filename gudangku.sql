...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 17, 2024 at 01:19 AM
...
INSERT INTO `barang` (`id`, `namaBarang`, `stok`, `hapus`) VALUES
(1, 'Roma malkist', 15, '1'),
(2, 'Indomie Soto', 0, '1'),
(3, 'Kopiko', 2, '1'),
(4, 'Buku', 7, '0');
...
(2, '2024-07-16', 'Budi', 'Bekasi', 2, '12', 'Budi', '082165443677', 'cash', 'pagi', 'acc', 4),
(3, '2024-07-17', 'ANDI', 'HUIU', 1, '2', 'Andika', '082165443677', 'credit', 'malam', 'acc', 4);
